...
public class Totem extends Ability {
	...
	public void onInteract(Player player, Action action) {
		...
		if (action.equals(Action.RIGHT_CLICK_AIR) || action.equals(Action.RIGHT_CLICK_BLOCK)) {
			...
			org.kitpvp.ability.abilities.objects.Totem totem = new org.kitpvp.ability.abilities.objects.Totem(player, player.getLocation(), type, amplifier, 20*10, 6, topMaterial, topByte);
