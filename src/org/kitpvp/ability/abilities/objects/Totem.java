...
public class Totem {
	...
	public Totem(Player player, Location location, PotionEffectType type, int amplifier, int lifeSpan, double range,
			Material topMaterial, byte topByte) {
		this.player = player;
	...
	private void startLife() {
		this.destroyRunnable = Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Core.getInstance(),
				new Runnable() {
