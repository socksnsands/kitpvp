...
public enum UnlockableSeries {
	...
	STARTER_ABILITY(ChatColor.YELLOW + "Starter",
			...
			Material.CHEST), 
	GOD_ABILITY(ChatColor.RED + "Gods", 
			"Premium series",
	...
	LASER_ABILITY(ChatColor.RED + "Laser",
			...
			"Omega Laser"),
			Material.CHEST),
	UNREAL_ABILITY(ChatColor.LIGHT_PURPLE + "Unreal", "These abilities can't be real?", Arrays.asList("Black Hole"), Material.ENDER_CHEST);
