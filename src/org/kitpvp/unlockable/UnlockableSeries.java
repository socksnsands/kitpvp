...
public enum UnlockableSeries {
	...
	STARTER_ABILITY(ChatColor.YELLOW + "Starter", "Starter series", Arrays.asList("Noob", "Heal"),
			Material.CHEST), GOD_ABILITY(ChatColor.RED + "Gods", "Premium series",
					Arrays.asList("Jesus", "Aphrodite", "Poseidon", "Zeus", "Hades", "Vovl"),
					Material.CHEST), WAR_ABILITY(ChatColor.RED + "War", "Premium series",
							Arrays.asList("Jet", "Explosive Grenade"),
							Material.CHEST), HEIGHTS_ABILITY(ChatColor.RED + "Heights", "Premium series",
									Arrays.asList("Anti-Stomper", "Stomper", "Trampoline"),
									Material.CHEST), SUPERHERO_ABILITY(ChatColor.RED + "Superhero", "Premium series",
											Arrays.asList("Flash", "Flame Aura", "Bulk Up", "Wind Storm", "Enrage",
													"Jedi"),
											Material.CHEST), DEV_ABILITY(ChatColor.BLUE + "Dev", "Dev testing series",
													Arrays.asList("Jesus", "Swap Laser"),
													Material.CHEST), WINTER_ABILITY(ChatColor.AQUA + "Winter",
															"Limited edition: Winter 2016",
															Arrays.asList("Frosty", "Snowball Shotgun", "Frost Laser"),
															Material.SNOW_BLOCK), LASER_ABILITY(ChatColor.RED + "Laser",
																	"Premium series",
